...
const ImageCard = () => {
  return (
    <div className="bg-[#f3fafc] w-full py-2 mb-28">
      ...
      <p className="text-center text-[17px]  mb-4 text-[#014584] mx-3 sm:max-xxl:text-[18px] ">See our cleaning services below or view our complete <Link to={"/cleaningchecklist"}> <span className="font-semibold">cleaning checklist.</span></Link></p>
